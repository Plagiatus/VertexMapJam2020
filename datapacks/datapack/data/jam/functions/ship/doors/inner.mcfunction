...
execute as @s[tag=opening] positioned ~-1 ~ ~-5 as @a[dx=2,dy=3,dz=4,tag=!in_ship] run function jam:oxygen/refill
execute as @s[tag=opening] positioned ~-1 ~ ~-5 run tag @a[dx=2,dy=3,dz=4] add in_ship
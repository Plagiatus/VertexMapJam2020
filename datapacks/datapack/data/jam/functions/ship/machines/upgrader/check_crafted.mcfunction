...
execute if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:stone_shovel"}]} run function jam:ship/machines/upgrader/check_crafted/stone
execute if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:iron_shovel"}]} run function jam:ship/machines/upgrader/check_crafted/iron

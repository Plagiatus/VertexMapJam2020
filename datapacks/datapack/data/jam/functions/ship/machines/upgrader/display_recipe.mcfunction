...
execute if score #iron tmp matches 0.. if score #gold tmp matches 0.. if score #diam tmp matches 0.. run replaceitem block ~ ~ ~ container.3 structure_void{CustomModelData:10}
execute if score #iron tmp matches 0.. if score #gold tmp matches 0.. if score #diam tmp matches 0.. run replaceitem block ~ ~ ~ container.4 structure_void{CustomModelData:11}
execute if score #iron tmp matches 0.. if score #gold tmp matches 0.. if score #diam tmp matches 0.. run replaceitem block ~ ~ ~ container.5 structure_void{CustomModelData:12}

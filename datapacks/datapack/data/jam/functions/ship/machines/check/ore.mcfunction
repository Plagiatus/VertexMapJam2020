...
execute if score @s tmp matches 0 unless block ~ ~ ~ hopper{Items:[{Slot:4b}]} if block ~ ~ ~ hopper{Items:[{Slot:0b,id:"minecraft:iron_ore"}]} run scoreboard players set @s tmp 1
execute if score @s tmp matches 0 unless block ~ ~ ~ hopper{Items:[{Slot:4b}]} if block ~ ~ ~ hopper{Items:[{Slot:0b,id:"minecraft:gold_ore"}]} run scoreboard players set @s tmp 1
execute if score @s tmp matches 0 unless block ~ ~ ~ hopper{Items:[{Slot:4b}]} if block ~ ~ ~ hopper{Items:[{Slot:0b,id:"minecraft:diamond_ore"}]} run scoreboard players set @s tmp 1

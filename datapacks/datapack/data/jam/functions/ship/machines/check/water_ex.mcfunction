...
execute if score @s tmp matches 0 unless block ~ ~ ~ hopper{Items:[{Slot:4b}]} if block ~ ~ ~ hopper{Items:[{Slot:0b,id:"minecraft:wet_sponge"}]} run scoreboard players set @s tmp 1

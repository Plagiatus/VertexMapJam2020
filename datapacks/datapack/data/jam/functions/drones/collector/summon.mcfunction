execute if entity @s[type=item] run give @p lime_dye{CustomModelData:1b,Unbreakable:1b}
...
scoreboard players operation @e[type=armor_stand,limit=1,distance=..1,tag=green_bot] botID = @p botID

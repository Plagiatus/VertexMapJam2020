...
#execute as @a if score @s ID = @e[sort=nearest,limit=1] ID at @s as @e[sort=nearest,limit=1] rotated as @s positioned ^4 ^ ^ run tp @s ~ ~2 ~
#													execute at dragonmaster95 as @e[type=armor_stand,tag=bot] rotated as @s positioned ^4 ^ ^ run tp @s ~ ~2 ~
